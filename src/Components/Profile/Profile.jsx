    ...
    return (
        ...
        <div div className='  w-11/12 bg-gray-500 p-10 rounded-lg mx-auto mb-20' >
            ...
            <div className='mt-3 '>
                ...
                <p className=' mx-auto p-3 rounded-lg bg-gray-400 text-white w-1/2'>name:</p>
                <p className=' mx-auto p-3 rounded-lg bg-gray-400 text-white mt-2 w-1/2'>email:</p>
